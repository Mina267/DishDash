...
import com.example.dishdash.search.view.onSearchClickListener;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsAdapter.ViewHolder> {
    ...
    public IngredientsAdapter(Context context, List<ListAllIngredient> ingredientsList, onIngredientsClickListener listener) {
